...
/* ─────────────────────────────────────────────────
   Login Page — DESIGN.md §7.5 / TODO §8.5
   Centered card layout with form, OAuth, and
...
function LoginPageInner() {
  ...
  return (
    <div className="w-full max-w-md overflow-hidden rounded-card bg-white p-8 shadow-card-hover md:p-10">
      <h1 className="mb-2 text-center text-page-title text-deep-navy">Welcome Back</h1>
      <p className="mb-8 text-center text-body text-charcoal/70">
        Log in to continue to LiveShopMarket.
      </p>
